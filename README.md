...
|-----------------------------------------------|-------------------------------------------------|-------------------------------------------|-----------------------------------------------|
| ![Dashboard](screenshots/home_screen.PNG)     | ![Inventory](screenshots/inventory_screen.PNG)  | ![Billing](screenshots/bills_screen.PNG)  | ![Delivery](screenshots/shop_list_screen.PNG) |
